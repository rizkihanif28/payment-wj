        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    ...
                    <hr>
                    <a href="{{ route('siswa.status-pembayaran.detail') }}" class="btn btn-danger btn-sm">
                ...
                {{-- card header --}}
                <div class="card-body">
                    <form method="POST" action="{{ route('siswa.bayarValidate', $siswa->nisn) }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-3">
